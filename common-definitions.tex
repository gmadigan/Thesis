...
% Gaugue Groups
\newcommand{\SUthreeC}{\ensuremath{\mathrm{SU(3)_{C}}}\xspace}
\newcommand{\SUtwoW}{\ensuremath{\mathrm{SU(2)_{W}}}\xspace}
...
\newcommand{\YW}{\ensuremath{Y_{\text{W}}}\xspace}
\newcommand{\Tthree}{\ensuremath{T_3}\xspace}
\newcommand{\weakangle}{\ensuremath{\theta_{\text{W}}}\xspace}
\newcommand{\PWewt}[1]{\HepParticle{\PW}{#1}{}\xspace}
\newcommand{\PBewt}{\HepParticle{B}{}{}\xspace}
\newcommand{\gammamu}{\ensuremath{\gamma^{\mu}}\xspace}
\newcommand{\spinor}[3]{\ensuremath{#1_{\textrm{#2}}^{\textrm{#3}}}\xspace}
\newcommand{\antispinor}[3]{\ensuremath{\overline{#1}_{\textrm{#2}}^{\textrm{#3}}}\xspace}


% Experimental quantities
\newcommand{\Ratio}[1]{\ensuremath{R_{\text{#1}}}\xspace}
\newcommand{\gmuon}{\ensuremath{g_{\Pmu}}\xspace}
\newcommand{\amuon}{\ensuremath{a_{\Pmu}}\xspace}

% LQ-analysis-specific recurring physics processes, physics objects, variables, etc.

% Signal processes
\newcommand{\LQ}{\HepParticle{LQ}{}{}\xspace}
\newcommand{\LQbar}{\HepAntiParticle{LQ}{}{}\xspace}
\newcommand{\LQToBMuPair}{\HepProcess{\LQ\LQbar \to \Pbottom\APbottom \Pmuon\APmuon}\xspace}
\newcommand{\ppToLQLQ}{\HepProcess{\Pp\Pp \to \LQ\LQbar}\xspace}

\newcommand{\MLQ}{\ensuremath{M_{\LQ}}\xspace}
\newcommand{\lambdaLQ}{\ensuremath{\lambda_{\LQ}}\xspace}

% LQ branching fractions to charged leptons vs neutrinos
\newcommand{\bfu}{\ensuremath{\beta}\xspace}
\newcommand{\bfv}{\ensuremath{1-\beta}\xspace}
\newcommand{\bfuu}{\ensuremath{\beta^2}\xspace}
\newcommand{\bfvv}{\ensuremath{(1-\beta)^2}\xspace}
\newcommand{\bfuv}{\ensuremath{2\beta(1-\beta)}\xspace}



% Final state particles/objects
\renewcommand{\APlepton}{\ensuremath{\overline{\Plepton}}\xspace}

\newcommand{\Pj}{\HepParticle{j}{}{}\xspace}
\newcommand{\jet}{\HepParticle{jet}{}{}\xspace}
\newcommand{\jets}{\HepParticle{jets}{}{}\xspace}

\newcommand{\PmuOne}{\HepParticle{\Pmu}{1}{}\xspace}
\newcommand{\PmuTwo}{\HepParticle{\Pmu}{2}{}\xspace}
\newcommand{\PjOne}{\HepParticle{\Pj}{1}{}\xspace}
\newcommand{\PjTwo}{\HepParticle{\Pj}{2}{}\xspace}
\newcommand{\jetOne}{\HepParticle{\jet}{1}{}\xspace}
\newcommand{\jetTwo}{\HepParticle{\jet}{2}{}\xspace}
\newcommand{\muonOne}{\HepParticle{muon}{1}{}\xspace}
\newcommand{\muonTwo}{\HepParticle{muon}{2}{}\xspace}

\newcommand{\mumubj}{\HepProcess{\Pmu\Pmu\Pbottom\Pj}\xspace}
\newcommand{\mumubb}{\HepProcess{\Pmu\Pmu\Pbottom\Pbottom}\xspace}
\newcommand{\mumujj}{\HepProcess{\Pmu\Pmu\Pj\Pj}\xspace}

% Background particles/processes
\newcommand{\PV}{\HepParticle{V}{}{}\xspace}
\newcommand{\ttbar}{\HepProcess{\Ptop\APtop}\xspace}
\newcommand{\VV}{\HepProcess{\PV\PV}\xspace}
\newcommand{\TTV}{\HepProcess{\ttbar\PV}\xspace}
\newcommand{\ZJETS}{\HepProcess{\PZ/\Pgammastar + \jets}\xspace}
\newcommand{\TTJETS}{\HepProcess{\ttbar + \jets}\xspace}
\newcommand{\WJETS}{\HepProcess{\PW + \jets}\xspace}
\newcommand{\VVJETS}{\HepProcess{\VV + \jets}\xspace}
\newcommand{\bbbar}{\HepProcess{\Pbottom\APbottom}\xspace}

% Background processes by dataset
% DY
\newcommand{\DYJetsToLL}{\HepProcess{\PZ/\Pgammastar \to \Pleptonminus\Pleptonplus}\xspace}

% tt-bar
\newcommand{\TTToHadronic}{\HepProcess{\ttbar \to \bbbar\Pq\Pq\Pq\Pq}\xspace}
\newcommand{\TTToSemiLeptonic}{\HepProcess{\ttbar \to \bbbar\Pq\Pq\Plepton\Pnu}\xspace}
\newcommand{\TTToLLNuNu}{\HepProcess{\ttbar \to \bbbar\Pbottom\Pleptonminus\Pleptonplus\APnu\Pnu}\xspace}

% Single top
\newcommand{\STschanToHadronic}{\HepProcess{\Ptop\Pbottom \to \bbbar\Pquark\Pquark}\xspace}
\newcommand{\STschanToLeptonic}{\HepProcess{\Ptop\Pbottom \to \bbbar\Plepton\Pnu}\xspace}
\newcommand{\STschanTopToLeptonic}{\HepProcess{\Ptop\APbottom \to \bbbar\Pleptonminus\APnu}\xspace}
\newcommand{\STschanAntiTopToLeptonic}{\HepProcess{\APtop\Pbottom \to \bbbar\Pleptonplus\Pnu}\xspace}
\newcommand{\STtchanTop}{\HepProcess{\Ptop\Pquark}\xspace}
\newcommand{\STtchanTopToLeptonic}{\HepProcess{\Ptop\Pquark \to \Pbottom\Pquark\Pleptonplus\Pnu}\xspace}
\newcommand{\STtchanAntiTop}{\HepProcess{\APtop\Pquark}\xspace}
\newcommand{\STtchanAntiTopToLeptonic}{\HepProcess{\APtop\Pquark \to \APbottom\Pquark\Pleptonminus\APnu}\xspace}
\newcommand{\STtWchanTop}{\HepProcess{\Ptop\PWminus}\xspace}
\newcommand{\STtWchanAntiTop}{\HepProcess{\APtop\PWplus}\xspace}

% W+Jets
\newcommand{\WJetsToLNu}{\HepProcess{\PW \to \Plepton\Pnu}\xspace}

% Diboson
\newcommand{\WWToLNuQQ}{\HepProcess{\PW\PW \to \Plepton\Pnu\Pquark\Pquark}\xspace}
\newcommand{\WWToQQQQ}{\HepProcess{\PW\PW \to \Pquark\Pquark\Pquark\Pquark}\xspace}
\newcommand{\WWToLLNuNu}{\HepProcess{\PW\PW \to \Plepton\Plepton\Pnu\Pnu}\xspace}
\newcommand{\WZToLNuQQ}{\HepProcess{\PW\PZ \to \Plepton\Pnu\Pquark\Pquark}\xspace}
\newcommand{\WZToLNuNuNu}{\HepProcess{\PW\PZ \to \Plepton\Pnu\Pnu\Pnu}\xspace}
\newcommand{\WZToLLQQ}{\HepProcess{\PW\PZ \to \Plepton\Plepton\Pquark\Pquark}\xspace}
\newcommand{\WZToLLLNu}{\HepProcess{\PW\PZ \to \Plepton\Plepton\Plepton\Pnu}\xspace}
\newcommand{\WZToQQNuNu}{\HepProcess{\PW\PZ \to \Pnu\Pnu \Pquark\Pquark}\xspace}
\newcommand{\ZZToLLLL}{\HepProcess{\PZ\PZ \to \Plepton\Plepton\Plepton\Plepton}\xspace}
\newcommand{\ZZToQQNuNu}{\HepProcess{\PZ\PZ \to \Pnu\Pnu\Pquark\Pquark}\xspace}
\newcommand{\ZZToQQQQ}{\HepProcess{\PZ\PZ \to \Pquark\Pquark\Pquark\Pquark}\xspace}
\newcommand{\ZZToLLQQ}{\HepProcess{\PZ\PZ \to \Plepton\Plepton\Pquark\Pquark}\xspace}
\newcommand{\VVToLLNuNu}{\HepProcess{\VV \to \Plepton\Plepton\Pnu\Pnu}\xspace}

% ttV
\newcommand{\TTHToBB}{\HepProcess{\ttbar\PHiggs \to \Pbottom\Pbottom}\xspace}
\newcommand{\TTHToNonBB}{\HepProcess{\ttbar\PHiggs \to \text{non-}\Pbottom\Pbottom}\xspace}
\newcommand{\TTWJetsToLNu}{\HepProcess{\ttbar\PW \to \Plepton\Pnu}\xspace}
\newcommand{\TTWJetsToQQ}{\HepProcess{\ttbar\PW \to \Pquark\Pquark}\xspace}
\newcommand{\TTZToLLNuNu}{\HepProcess{\ttbar\PZ \to \Plepton\Plepton\Pnu\Pnu}\xspace}
\newcommand{\TTZToQQ}{\HepProcess{\ttbar\PZ \to \Pquark\Pquark}\xspace}


% Kinematic quantities
\newcommand{\MZ}{\ensuremath{M_{\PZ}}\xspace}
\newcommand{\ST}{\ensuremath{S_{\text{T}}}\xspace}
\newcommand{\Muu}{\ensuremath{M_{\Pmu\Pmu}}\xspace}
\newcommand{\Muujj}{\ensuremath{M_{\Pmu\Pmu\Pj\Pj}}\xspace}
\newcommand{\MujOne}{\ensuremath{M_{\Pmu\Pj_1}}\xspace}
\newcommand{\MujTwo}{\ensuremath{M_{\Pmu\Pj_2}}\xspace}
\newcommand{\ptof}[1]{\ensuremath{\pt(#1)}\xspace}
\newcommand{\Rspacial}{\ensuremath{R}\xspace}
\newcommand{\DR}{\ensuremath{\Delta R}\xspace}
\newcommand{\DRof}[2]{\ensuremath{\DR(#1,#2)}\xspace}
\newcommand{\sqrts}{\ensuremath{\sqrt{s}}\xspace}
\newcommand{\sqrtsTeV}[1]{\ensuremath{\sqrt{s} = \SI{#1}{\TeV}}\xspace}
\newcommand{\pseudorap}{\ensuremath{\eta}\xspace}
\newcommand{\abspseudorap}{\ensuremath{\abs{\eta}}\xspace}
\newcommand{\mom}{\ensuremath{p}\xspace}
\newcommand{\xsec}{\ensuremath{\sigma}\xspace}
\newcommand{\xsecSS}[1]{\ensuremath{\sigma_{\text{#1}}}\xspace}
\newcommand{\ct}{\ensuremath{c\tau}\xspace}



% Scale Factors
\newcommand{\SF}[2]{\ensuremath{\text{SF}^{\text{#1}}_{\text{#2}}}\xspace}
\newcommand{\RZ}{\ensuremath{R_{\PZ}}\xspace}
\newcommand{\RTT}{\ensuremath{R_{\ttbar}}\xspace}
\newcommand{\RVV}{\ensuremath{R_{\VV/\TTV}}\xspace}
\newcommand{\Nevents}[1]{\ensuremath{N_{\text{#1}}}\xspace}
\newcommand{\NCR}[2]{\ensuremath{N^{\text{#1}}_{\text{#2}}}\xspace}

% HEM failure
\newcommand{\RatioDataAB}{\ensuremath{\text{Data}^\text{B}/\text{Data}^\text{A}}\xspace}
...
%\renewcommand{\eV}{\ensuremath{\,\text{e\hspace{-.08em}V}}\xspace}
